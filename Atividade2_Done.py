#! /usr/bin/env python
# -*- coding:utf-8 -*-
#Youtube link: https://youtu.be/Ufvm6kAfRnY
...
def identifica_cor(frame):
    ...
    cor_menor = np.array([140, 100, 100])
    cor_maior = np.array([180, 240, 240])
    ...
    if not maior_contorno is None :
        ...
        media_real.append(len(maior_contorno))
...
while(True):
    ...
    if len(media_real)>45:
        media_real.pop(0)

    print(4300/(np.array(media_real).mean()))
